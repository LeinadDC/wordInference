...
r = redis.Redis(host='127.0.0.', port=6379, db=0)
...
adjetivosMinuscula = []    
for palabra in adjetivosLista:
    l = [palabra.lower() for palabra in l]
    adjetivosMinuscula.append(l)
